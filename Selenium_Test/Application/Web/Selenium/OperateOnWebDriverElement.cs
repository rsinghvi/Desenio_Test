...
namespace SAFEBBA.Application.Web.Selenium
{
    /// <summary>
    ...
    public class OperateOnWebDriverElement
    {
        ...
        {            
            ...
            {
                SAFEBBALog.Info("FAILED TO CLICK THE FIRST TIME. MAKE A SECOND TRY");
        ...
        /// <summary>
        /// Click an element. no frame switch, no window switch
        /// The element is identified by the LinkText of the element 
        /// </summary>
        /// <param name="idForElementToClick"></param>
        public void ClickAnElementByLinkText(String linkTextForElementToClick)
        {
            ClickAnElementByLinkText(null, linkTextForElementToClick);
        }
        ...
        /// <param name="frameNameToSwitchTo"></param>
        /// <param name="idForElementToClick"></param>
        public void ClickAnElementByLinkText(string frameNameToSwitchTo, String linkTextForElementToClick)
        {
            ClickAnElementByLinkText(null, frameNameToSwitchTo, linkTextForElementToClick);
        }
        ...
        /// <param name="frameNameToSwitchTo"></param>
        /// <param name="idForElementToClick"></param>
        public void ClickAnElementByLinkText(string pageNameToSwitchTo, string frameNameToSwitchTo, String linkTextForElementToClick)
        {
            SAFEBBALog.Debug(CommonUtilities.GetClassAndMethodName());
            IWebElement webelement = findWebDriverElement.waitForElementByLinkText(pageNameToSwitchTo, frameNameToSwitchTo, linkTextForElementToClick);
            try
            {
                webelement.Click();
            }
            ...
            {
                SAFEBBALog.Info("FAILED TO CLICK THE FIRST TIME. MAKE A SECOND TRY");
                webelement = findWebDriverElement.waitForElementById(pageNameToSwitchTo, frameNameToSwitchTo, linkTextForElementToClick);
                webelement.Click();
            }
        }
 ...
 */
        ...
        public void clickAnElementByIdUsingJavaScript(string pageNameToSwitchTo, string frameNameToSwitchTo, string idForElementToClick)
        {
            ...
            SAFEBBALog.Debug(CommonUtilities.GetClassAndMethodName(), "clickAWebElementByIdUsingJavaScript, scriptToExecute: " + scriptToExecute);
...
//}
        ...
        public void clickAnElementByNameUsingJavaScript(string pageNameToSwitchTo, string frameNameToSwitchTo, string nameForElementToClick)
        {
            ...
            SAFEBBALog.Debug(CommonUtilities.GetClassAndMethodName(), "clickAWebElementNameIdUsingJavaScript, scriptToExecute: " + scriptToExecute);
            javaScriptCalls.executeJavaScriptWithWaitForAjaxCallToFinish(pageNameToSwitchTo, frameNameToSwitchTo, scriptToExecute);
        }
        ...
        //{
        //    SAFEBBALog.Debug(CommonWindowsAndPages.GetClassAndMethodName());
