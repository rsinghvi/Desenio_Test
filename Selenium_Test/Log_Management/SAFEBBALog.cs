...
namespace SAFEBBA.LogMgn
{
    public class SAFEBBALog : ConfigParameters
    {
        public static readonly ILog logger = LogManager.GetLogger(typeof(SAFEBBALog));
        ...
        {
            get { return SAFEBBALog.isPreviousTestCaseFailed; }
            set { SAFEBBALog.isPreviousTestCaseFailed = value; }
        }

        public static int NumberOfSucceededTests
        {
            get { return SAFEBBALog.numberOfSucceededTests; }
            set { SAFEBBALog.numberOfSucceededTests = value; }
        }

        public static int NumberOfExecutedTests
        {
            get { return SAFEBBALog.numberOfExecutedTests; }
            set { SAFEBBALog.numberOfExecutedTests = value; }
        }
